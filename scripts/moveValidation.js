...
// Function to check the validity of a pawn move
...
// Function to check the validity of a rook move
export const isValidRookMove = function (prevCol, nextCol, prevRow, nextRow) {
        ...
        if (prevCol === nextCol) {
            ...
            // Iterate over the squares along the vertical path
        ...
        if (prevRow === nextRow) {
            ...
            // Iterate over the squares along the horizontal path
...
// Function to check the validity of a knight move
...
// Function to check the validity of a bishop move
...
// Function to check the validity of a queen move
...
// Function to check the validity of a king move
